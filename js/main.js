  ...
  $.getJSON( publicPhotoListing, {
    ...
    .done(function( data ) {
      ...
      $.each( data.photos.photo, function( i, item ) {
        ...
        // Working on a list of tags to turn into filters.
        ...
        returnHTML = "<div class='sm-col sm-col-6 md-col-4 lg-col-3 item'>";
        returnHTML += "<div class='pic-card mx2 mb3'><div class='pic-crop'>";
        returnHTML += "<img src='" + mediumImage + "' alt='" + item.title + "' /></div>";
        returnHTML += "<p class='p2 m0'>" + item.title + "</p>";
        returnHTML += "</div></div>";
